...
GO
INSERT INTO transition ([id], [state_from_id], [state_to_id], [predicate]) VALUES (2, 1, 9, eq(1, 1))
GO
...
GO
INSERT INTO transition ([id], [state_from_id], [state_to_id], [predicate]) VALUES (11, 5, 0, eq(1, 1))
GO
INSERT INTO transition ([id], [state_from_id], [state_to_id], [predicate]) VALUES (12, 4, 0, eq(1, 1))
GO
...
GO
INSERT INTO transition ([id], [state_from_id], [state_to_id], [predicate]) VALUES (17, 6, 0, eq(1, 1))
GO
INSERT INTO transition ([id], [state_from_id], [state_to_id], [predicate]) VALUES (18, 6, 7, eq(1, 1))
GO
INSERT INTO transition ([id], [state_from_id], [state_to_id], [predicate]) VALUES (19, 7, 8, eq(1, 1))